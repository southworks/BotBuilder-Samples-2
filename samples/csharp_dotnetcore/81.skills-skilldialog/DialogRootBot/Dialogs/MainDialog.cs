...
namespace Microsoft.BotBuilderSamples.DialogRootBot.Dialogs
{
    ...
    public class MainDialog : ComponentDialog
    {
        ...
        protected override async Task<DialogTurnResult> OnContinueDialogAsync(DialogContext innerDc, CancellationToken cancellationToken = default)
        {
            ...
            if (activeSkill != null && activity.Type == ActivityTypes.Message && activity.Text.Equals("abort", StringComparison.Ordinal))
            {
        ...
        private Activity CreateDialogSkillBotActivity(string selectedOption, ITurnContext turnContext)
        {
            ...
            if (selectedOption.Equals(SkillActionMessage, StringComparison.Ordinal))
            {
            ...
            if (selectedOption.Equals(SkillActionBookFlight, StringComparison.Ordinal))
            {
            ...
            if (selectedOption.Equals(SkillActionBookFlightWithInputParameters, StringComparison.Ordinal))
            {
                activity = (Activity)Activity.CreateEventActivity();
                activity.Name = SkillActionBookFlight;
            ...
            if (selectedOption.Equals(SkillActionGetWeather, StringComparison.Ordinal))
            {
                activity = (Activity)Activity.CreateEventActivity();
