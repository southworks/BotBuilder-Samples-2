...
namespace Microsoft.BotBuilderSamples.Bots
{
    ...
    public class DialogBot<T> : ActivityHandler
        where T : Dialog
    {
#pragma warning disable CA1051 // Do not declare visible instance fields. We exclude this rule because the child class DialogAndWelcomeBot sohuld call its parant's RunAsync method.
