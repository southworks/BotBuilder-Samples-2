    ...
    public class AdapterWithErrorHandler : CloudAdapter
    {
        ...
        private async Task EndSkillConversationAsync(ITurnContext turnContext)
        {
            ...
            try
            {
                ...
                var activeSkill = await _conversationState.CreateProperty<BotFrameworkSkill>(RootBot.ActiveSkillPropertyName).GetAsync(turnContext, () => null).ConfigureAwait(false);
                if (activeSkill != null)
                {
